...
class LikeToggleTestCase(TestCase):
    ...
    def test_like_brian(self):
        ...
        with mock.patch('like.signals.object_liked.send', autospec=True) as mocked_handler:
    ...
    def test_unlike_james(self):
        ...
        with mock.patch('likes.signals.object_unliked.send', autospec=True) as mocked_handler:
            response = LikeToggleView.as_view()(
                request,
                content_type_id=self.user_content_type.pk,
                object_id=james.pk
    ...
    def test_like_michael_ajax(self):
        ...
        request.user = self.user
        with mock.patch('likes.signals.object_liked.send', autospec=True) as mocked_handler:
            response = LikeToggleView.as_view()(
                request,
                content_type_id=self.user_content_type.pk,
                object_id=michael.pk
